...
#define MULTIROTOR_SPEEDCONTROLLER_VXY_MAX 			2.0 // m/s
...
#define MULTIROTOR_POSITIONCONTROLLER_VXVY_DELTA_KP (0.25)
...
#define MULTIROTOR_POSITIONCONTROLLER_VXVY_KD 	MULTIROTOR_POSITIONCONTROLLER_VXVY_DELTA_KP*2.0400*1.62
