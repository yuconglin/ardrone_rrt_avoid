...
namespace user_types{
  ...
  struct ArdroneState:public GeneralState{
    ...
    ArdroneState(double _x,double _y,double _z,double _t,double _yaw,double _vx,double _vy,double _vz,double _yaw_rate,double _ax,double _ay,double _az,double _a_yaw){};
